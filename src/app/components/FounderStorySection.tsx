...
export function FounderStorySection() {
  return (
    <section className="py-20 bg-[#5a6a5b]">
      <div className="max-w-[1400px] mx-auto px-8">
        ...
        <div className="grid grid-cols-2 gap-12 items-center">
          ...
          {/* Story */}
          <div className="bg-[#e8e5d9] p-12 rounded-lg shadow-lg">
            <h3 
              className="text-3xl font-serif text-[#3a4a3b] mb-6"
              style={{ fontFamily: 'Playfair Display, serif' }}
            >
              From Lost to Found
            </h3>
            <p 
              className="text-[#5a6a5b] leading-relaxed mb-6"
            ...
            <p 
              className="text-[#5a6a5b] leading-relaxed mb-8"
              style={{ fontFamily: 'Source Serif 4, serif' }}
            >
            ...
            {/* Testimonial */}
            <div className="border-t border-[#c5c2b5] pt-6">
              <div className="flex gap-1 mb-3">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-[#d17d47] text-[#d17d47]" />
                ))}
              </div>
              <p 
